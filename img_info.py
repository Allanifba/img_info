...
layout = [
    ...
    [sg.Button(image_filename='0.png',key='im0',visible=True),
     sg.Button(image_filename='0.png',key='im1',visible=True),
     sg.Button(image_filename='0.png',key='im2',visible=True),
     sg.Button(image_filename='0.png',key='im3',visible=True),
     sg.Button(image_filename='0.png',key='im4',visible=True)],
    ...
    [sg.Button(image_filename='0.png',key='im5',visible=True),
     sg.Button(image_filename='0.png',key='im6',visible=True),
     sg.Button(image_filename='0.png',key='im7',visible=True),
     sg.Button(image_filename='0.png',key='im8',visible=True),
     sg.Button(image_filename='0.png',key='im9',visible=True)]
]
...
while True:
    ...
    if event == 'Limpar':
        for imagem in imagens:
            imagem.Update(image_filename='0.png', visible=True)
        for i in range(0, 10):
